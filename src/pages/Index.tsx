    ...
    <Layout>
      ...
      <section className="relative min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            <h2 
              className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground uppercase tracking-widest mb-3 sm:mb-4 md:mb-6 animate-fade-in"
              style={{ animationDelay: "0.1s" }}
            >
              Welcome to Scholar Campus
            </h2>
            <h1 
              className="text-xl sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-foreground leading-tight mb-4 sm:mb-6 md:mb-8 animate-fade-in-up font-serif px-2"
            ...
            >
              <div className="inline-block bg-secondary/50 rounded-lg px-4 sm:px-6 py-3 sm:py-4 mb-4 sm:mb-6 md:mb-8">
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-foreground tracking-wider">
                  VERITAS
                </p>
      ...
      <section className="py-10 sm:py-14 md:py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-6 sm:mb-8 md:mb-12">
            <h2 className="text-xs sm:text-sm uppercase tracking-widest text-muted-foreground mb-2 sm:mb-3 animate-fade-in">
              Latest Updates
            </h2>
            <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-foreground animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
              News & Events
            </h3>
          </div>
      ...
      <section className="py-10 sm:py-14 md:py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 animate-fade-in-up">
